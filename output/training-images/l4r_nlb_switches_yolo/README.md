...
六类：`fork/merge × left/right/unknown`。无道岔但有完整 JSON 的图片保留为空标签负样本。
相邻帧按“季节 + frame_id 时间块”整体划分，避免连续画面跨 split。

- 可用图片：7056（正样本 772，负样本 6284）
- 道岔框：1135，类别分布：`{"merge_left": 157, "merge_unknown": 337, "fork_unknown": 209, "merge_right": 179, "fork_left": 122, "fork_right": 131}`
